        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uploadTask != null && uploadTask.isInProgress()){
                    Toast.makeText(teacher_admin.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                }else {
                    uploadFile();
                }
            }
            ...
            uploadTask = fileReference.putFile(imaageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(teacher_admin.this, "Upload Successfull!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(teacher_admin.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
